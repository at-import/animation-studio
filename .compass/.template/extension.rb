...
#  extension.<% _.forEach(grunt.userConfig.dependencies, function(version, extension) { %>
require '<%= extension %>'<% }); %>
...
Compass::Frameworks.register('<%= grunt.userConfig.extSlug %>', :stylesheets_directory => stylesheets_dir, :templates_directory => templates_dir)
...
module <%= grunt.userConfig.extCamelCase %>
